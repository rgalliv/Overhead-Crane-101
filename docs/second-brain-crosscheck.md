...
| G5 | **NAVFAC P-307** — *current edition* | not cited, should be | ⬇️ **Downgraded 2026-08-07.** P-307 **is held** — September 2000 and June 2006 editions, both on SharePoint. The register's "unopened/blocked" status was wrong; the real gap is that the held copies are ~20 years behind the January 2025 edition. Usable now for program architecture; refresh before citing anything edition-sensitive. |

# OHC-06 &mdash; Element-to-Item Trace Table

> **Generated file.** Emitted by `build/gen_trace.py 06` from the same question data that builds the module. Do not hand-edit &mdash; regenerate.
...
|---|---|---|
| `OHC_M06_q01` | `OHC.06.A.K1` | A sling with an illegible rated-load tag may be used if its diameter matches a known sling. |
| `OHC_M06_q02` | `OHC.06.A.K3` | A two-leg bridle lifts a 24,000 lb load at a 45&#176; sling angle. Tension in each leg is about: |
| `OHC_M06_q03` | `OHC.06.A.K3b` | At a 30&#176; sling angle, each leg of a two-leg bridle carries: |
| `OHC_M06_q04` | `OHC.06.A.K4` | A hook's rated load applies when the load is applied: |
| `OHC_M06_q05` | `OHC.06.B.K2` | A 15,000 lb crane uses a 1,200 lb spreader beam and 400 lb of slings. Available payload is: |
| `OHC_M06_q06` | `OHC.06.B.K3` | A lifting magnet that loses power will hold the load until it is set down. |
| `OHC_M06_q07` | `OHC.06.C.K1` | A load hangs level when the hook is directly above: |
| `OHC_M06_q08` | `OHC.06.C.K2` | A load that tilts at a six-inch test lift will straighten as it rises. |
| `OHC_M06_q09` | `OHC.06.C.K4` | Wrapping a tag line around the hand for grip is: |

---

## Performance items &mdash; `OHC_M06_PES.docx`

Not scored by the bridge. Evaluator sign-off, dated, scoped to named equipment.

| Item | Element | Demonstration |
|---|---|---|
| `OHC06-P01` | `OHC.06.A.S1` | Verify sling tag, condition and hitch before hoisting |
| `OHC06-P02` | `OHC.06.A.S2` | Reject deficient rigging and state the reason |
| `OHC06-P03` | `OHC.06.A.S3` | Confirm hook engagement and latch closure on every pick |
| `OHC06-P04` | `OHC.06.B.S1` | Perform device pre-use checks including power and alarm functions |
| `OHC06-P05` | `OHC.06.B.S2` | Demonstrate engagement verification and a test lift at low height |
| `OHC06-P06` | `OHC.06.B.S3` | Compute total lifted load with device weight included |
| `OHC06-P07` | `OHC.06.C.S1` | Execute a test lift and balance verification sequence |
| `OHC06-P08` | `OHC.06.C.S2` | Direct a rigging correction for an off-CG condition |
| `OHC06-P09` | `OHC.06.C.S3` | Manage tag line use for an orientation-critical load |

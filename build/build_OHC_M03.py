...
GATE = [
    ...
    ("OHC.03.B.K4",
     "A wireless operator hands over mid-shift. The transfer protocol requires that:",
     ["The transmitter is passed over with the crane still selected",
      "The transmitter is deactivated, custody is explicitly transferred, and the incoming "
      "operator re-verifies the transmitter-to-crane assignment",
      "The outgoing operator keeps the transmitter until end of shift",
      "The transmitter is left on the crane's park stand"], 1, ""),
    ("OHC.03.B.K4b",
     "An unattended active transmitter defeats which requirement directly?",
     ["The rated load marking at &sect;1910.179(b)(5)",
      "&sect;1910.179(b)(8) &#8212; only designated personnel shall be permitted to operate",
      "The limit switch test at (n)(4)(i)", "The clearance rule at (b)(6)(i)"], 1, ""),
    ("OHC.03.B.K5",
    ...
    ("OHC.03.C.K4",
     "A cab operator cannot see the landing area for a placement. EM 385 &sect;16.G.05.b "
     "requires that:",
     ["The operator proceed at reduced speed",
      "A signal person be used",
      "The placement be rescheduled",
      "The load be raised for a better view"], 1, ""),
    ("OHC.03.C.K5",
...
TRACE_SOURCE = {
    ...
    "OHC.03.B.K4": ("derived &middot; **&sect;1910.179(b)(8)** &middot; `OHC.08.C.K3`", "OK"),
    "OHC.03.B.K4b": ("**&sect;1910.179(b)(8)**", "OK"),
    ...
    "OHC.03.C.K4": ("**EM 385 &sect;16.G.05.b(1)** &middot; `OHC.09.A.K2`", "ED2014"),

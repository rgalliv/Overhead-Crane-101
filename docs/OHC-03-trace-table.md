...
## Task A &mdash; Floor and Pendant Operation

| Item | Element | Stem | Form | Source | Status |
|---|---|---|---|---|---|
| `OHC_M03_q10` | `OHC.03.A.K1` | The maximum permitted voltage at pendant push-buttons is: | MC | &sect;1910.179(g)(1)(iii) &middot; Tier 0 pendant criteria | &#9989; |
...
## Task B &mdash; Wireless Remote Operation

| Item | Element | Stem | Form | Source | Status |
|---|---|---|---|---|---|
| `OHC_M03_q18` | `OHC.03.B.K1` | Which transmitter control should be verified first during pre-use checks? | MC | derived &middot; Tier 0 unfamiliar-crane routine | &#9989; |
...
|---|---|---|
| `OHC_M03_q01` | `OHC.03.A.K2` | On federal work, a hard-wired pendant-operated overhead crane makes its operator: |
| `OHC_M03_q02` | `OHC.03.A.K4` | While walking a load with a pendant, standing between the load and a fixed rack is acceptable if the load is moving slowly. |
| `OHC_M03_q03` | `OHC.03.A.K5` | Allowing the crane to coast to a stop rather than using the braking system or control reversal is: |
| `OHC_M03_q04` | `OHC.03.B.K2` | A wireless-operated overhead crane rated at 25 tons places its operator in: |
| `OHC_M03_q05` | `OHC.03.B.R2` | In a bay with several wireless cranes, the first action before any motion is to: |
| `OHC_M03_q06` | `OHC.03.B.K4` | An operator finishing a lift is called to another task and pockets the still-active transmitter. This is: |
| `OHC_M03_q07` | `OHC.03.C.K2` | A cab-operated overhead crane places its operator in: |
| `OHC_M03_q08` | `OHC.03.C.K1` | Access to a crane cab or bridge walkway must require no step over any gap exceeding: |
| `OHC_M03_q09` | `OHC.03.C.K5` | Which extinguisher type is specifically prohibited in a crane cab? |
...
|---|---|---|
| `OHC03-P01` | `OHC.03.A.S1` | Maintain correct standing position relative to load and travel direction |
| `OHC03-P02` | `OHC.03.A.S2` | Execute smooth acceleration and deceleration without load swing |
| `OHC03-P03` | `OHC.03.A.S3` | Stop and reposition before continuing when the travel path degrades |
| `OHC03-P04` | `OHC.03.B.S1` | Verify transmitter-to-crane assignment before first motion |
| `OHC03-P05` | `OHC.03.B.S2` | Demonstrate E-stop and recovery procedure |
| `OHC03-P06` | `OHC.03.B.S3` | Select and justify operating positions for a lift sequence |
| `OHC03-P07` | `OHC.03.C.S1` | Perform cab access, pre-use checks and egress per facility procedure |
| `OHC03-P08` | `OHC.03.C.S2` | Complete a lift requiring signaler-directed blind placement |
| `OHC03-P09` | `OHC.03.C.S3` | Demonstrate emergency egress awareness for the assigned cab crane |

---

## Source notes

**&#9989; EM 385 Class I / II now sourced** &mdash; `A.K2`, `B.K2`, `B.K2b` and `C.K2` were blocked pending EM 385 Section 16's general paragraphs. Those were located and read: **&sect;16.C.02** (Class I types), **&sect;16.C.05** (Class II types), **&sect;16.C.04** and **&sect;16.C.07** (training hours). The 2014 &rarr; 2024 crosswalk is clean &#8212; 16.C.02 is the spec's `16-2.g`, 16.C.05 is `16-2.h`.

**&#9888;&#65039; Edition basis** &mdash; Those four items were read from the **2014** Section 16 extract, which numbers by letter (&sect;16.C). The **content** is verified; the **2024 paragraph numbers** are taken on the subject-matter owner's verification. Cite the concept and the class, not a 2024 paragraph number, until the 2024 numbering is read directly.

**&#9888;&#65039; `A.K5` plugging &mdash; house position needed** &mdash; The shipped Tier 0 deck states *"never allow the crane to coast to a stop, use plugging or the braking system."* The ACS frames plugging as a load-swing cause and contrasts it with controlled deceleration. **The item is written to reconcile both**: plugging is legitimate and beats coasting, but induces swing and wear, so controlled deceleration is preferred where the situation allows. This reconciliation needs sign-off, or the two courses will teach differently.

**&#9432; Two elements carry two items** &mdash; `OHC.03.B.K2` and `OHC.03.C.K3` each carry a second item (`B.K2b`, `C.K3b`) because each element contains two independently testable facts &#8212; the 30-ton threshold and its continually-guided exemption; full view of the hook and the 3-inch cab clearance. Coverage stays 1:1 by element; the gate is 24 items over 15 K + 9 R.
